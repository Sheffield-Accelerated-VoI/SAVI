...
## 2.3 The Cost-Effectiveness Acceptability Curve CHECK THIS

Quitting from lines 126-130 (report.Rmd) 

Error in `[.data.frame`(costs, which.max(ceac.obj$p[which(ceac.obj$l.seq ==  : 
